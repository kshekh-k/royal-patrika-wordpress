 <div x-data="{ tab: 'mostview' }" class="pt-5 lg:pt-10">

                    <!-- TAB BUTTONS -->
                    <div class="flex items-center gap-4 text-sm">
                        <button @click="tab = 'mostview'"
                            :class="tab === 'mostview' ? 'text-white bg-blue-900' : 'text-neutral-500'"
                            class="px-4 py-2 truncate font-semibold cursor-pointer">
                            Most Viewed
                        </button>

                        <button @click="tab = 'popular'"
                            :class="tab === 'popular' ? 'text-white bg-blue-900' : 'text-neutral-500'"
                            class="px-4 py-2 truncate font-semibold cursor-pointer">
                            Popular News
                        </button>
                    </div>
