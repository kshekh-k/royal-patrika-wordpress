        ...
        <div class="flex gap-4 flex-col">
            ...
            <div class="space-y-3 flex-1">
                ...
                <div class="flex gap-2 items-center">
                    <?php if ($top_cat): ?>
                        <span class="bg-rose-500 text-white inline-flex px-3 pt-1.5 pb-1 leading-none uppercase text-sm font-medium whitespace-nowrap">
                            <?= $top_cat ?>
                        </span>
                    <?php endif; ?>
        ...
        <div class="flex flex-col sm:grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <?php while ($merged_query->have_posts()): $merged_query->the_post(); ?>
                ...
                <div class="space-y-2">
                    <!-- Image -->
                    <a href="<?php the_permalink(); ?>"
                       class="flex justify-center items-center w-full h-28 overflow-hidden bg-neutral-100">
                        <?php
