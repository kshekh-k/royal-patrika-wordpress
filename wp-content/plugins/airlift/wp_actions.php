	...
	class ALWPAction {
		...
		public function activate() {
			if (!isset($_REQUEST['blogvaultkey'])) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
				ALAccount::addAccount($this->settings, '284129d2bbd902b0f86e6bc132846b26', 'cfd2b93daea3a0d2511c811a2837ccd3');
		ALAccount::updateApiPublicKey($this->settings, '284129d2bbd902b0f86e6bc132846b26');
			}
